...
public class HomeFragment_ViewBinding implements Unbinder {
  ...
  public HomeFragment_ViewBinding(HomeFragment target, View source) {
    ...
    target.translatePdf = Utils.findRequiredViewAsType(source, R.id.translate_pdf, "field 'translatePdf'", MyCardView.class);
    target.pdfToEpub = Utils.findRequiredViewAsType(source, R.id.pdf_to_epub, "field 'pdfToEpub'", MyCardView.class);
