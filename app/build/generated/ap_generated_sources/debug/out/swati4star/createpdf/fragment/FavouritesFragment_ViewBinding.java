...
public class FavouritesFragment_ViewBinding implements Unbinder {
  ...
  public FavouritesFragment_ViewBinding(final FavouritesFragment target, View source) {
    ...
    target.pref_translate_pdf = Utils.findRequiredViewAsType(source, R.id.translate_pdf_fav, "field 'pref_translate_pdf'", MyCardView.class);
    target.pref_pdf_to_epub = Utils.findRequiredViewAsType(source, R.id.pdf_to_epub_fav, "field 'pref_pdf_to_epub'", MyCardView.class);
  ...
  public void unbind() {
    ...
    target.pref_translate_pdf = null;
    target.pref_pdf_to_epub = null;
